            ...
            <b-col sm="6" md="6">
                <b-card>
                    ...
                    <ul style="list-style:none">
                        ...
                        <li><h6><span class="font-weight-bold">  Status :</span> <span class="ml-2 badge badge-warning">completed</span>
                        </h6></li>
                        ...
                        <li><h6><span class="font-weight-bold">  Order Created At :</span><span class="ml-2">2018-11-14 19:50:00</span>
                        </h6></li>
