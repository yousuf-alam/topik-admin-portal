<template>
    ...
    <b-row>
        ...
        <b-col sm="2" class="mb-3">
            <router-link :to="{ name: 'OrderCreate'}"><button class="btn btn-success">Create New Order</button></router-link>
        </b-col>
    </b-row>
    <b-row>
        <b-col>
...
<script>
    ...
    export default {
        name: 'Orders',
        components: {Table, TableColumn, Button, Pagination, VueRouter},
        data() {
            return {
                tableData: [{
                    date: '2016-05-03',
