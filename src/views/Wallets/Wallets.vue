                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <router-link :to="{ name: 'Wallet / Show', params: { id: 1 }}"><span class="btn btn-primary btn-sm m-1" data-toggle="tooltip" data-placement="top" title="Show"><i class="fa fa-search"></i></span></router-link>
                        </template>
                    </el-table-column>
                </el-table>
            </b-col>
